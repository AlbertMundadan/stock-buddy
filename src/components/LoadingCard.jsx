const LoadingNewsCard = () => {
  return (
    <div className="flex grow">
        <div className="backdrop-blur-3xl  bg-white/5 w-full mx-3 min-h-40  mt-2.5 py-1 px-2 rounded-2xl font-francois ">
            <div className='flex justify-center h-full items-center' role="status">
