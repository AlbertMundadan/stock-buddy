      ...
      return (
        ...
        <div className="min-w-92 w-4/5 max-w-full h-184 mx-3 mt-4">
          <div className="backdrop-blur-3xl bg-gray-950/40 w-full h-100 rounded-2xl shadow-lg border-slate-900 border-2 mb-3">
            <div className="text-white text-3xl font-francois flex flex-col justify-center items-center pt-10">
            ...
            <Link
              to="/"
              className="text-white bg-gray-700 hover:bg-gray-800 text-lg rounded-md px-3 py-2 mt-4 ">
              Go Back
            </Link>
            </div>
          </div>
